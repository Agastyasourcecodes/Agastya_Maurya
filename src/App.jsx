...
export default function App() {
  ...
  const piecesSpread = useTransform(
    scrollYProgress,
    [0.12, 0.25],
    [0, 300]
  );
  ...
  const experience = [
    {
      ...
      certifications: [
        { title: "Agile Scrum Foundation", issuer: "Infosys Springboard" }
      ]
    }
  ];
  ...
  const achievements = [
    {
      ...
      subtitle: "NPTEL Software Testing Course",
      desc: "Course Topper · Feb–Mar 2026",
      icon: "🏆"
    },
    {
      title: "Database Design Certified",
      subtitle: "Oracle Academy",
      desc: "ID: 1729085490945",
      icon: "🎓"
    }
  ];
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center max-w-7xl w-full">
          ...
          >
            ...
            <p className="mt-10 text-xl md:text-2xl text-gray-300 leading-[2.2rem] font-light max-w-2xl tracking-wide">
              ...
              Backend & Full Stack Developer crafting scalable MERN
              applications, immersive user experiences, secure APIs,
              and futuristic web systems.
      ...
      <section id="about" className="px-6 py-32">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
            className="glow-impact md:col-span-2 bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-[40px]"
          >
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl font-black text-gray-200 mb-6">Highlights</h3>
